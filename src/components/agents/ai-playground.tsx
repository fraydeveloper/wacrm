    ...
    try {
      ...
      if (!res.ok) {
        if (data.code === 'ai_not_configured') {
          toast.error('Aún no hay un agente configurado — termina la configuración primero.');
        } else {
        ...
        {turns.length === 0 && (
          <div className="flex h-full flex-col items-center justify-center text-center text-sm text-muted-foreground">
            ...
            <p className="mt-1 text-xs">
              Usa tu base de conocimiento y se comporta exactamente igual que
              el bot de respuesta automática, incluida la transferencia a un humano.
            </p>
            {onGoToSetup && (
              <Button
                variant="link"
            ...
            >
              ...
              {t.role === 'assistant' && t.handoff && (
                ...
                >
                  ...
                  Aquí transferiría la conversación a un humano
                </p>
              )}
            </div>
            {t.role === 'user' && (
