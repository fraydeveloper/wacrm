  ...
  switch (node.node_type) {
    ...
    case "collect_input":
      return (
        <>
          <TextRow
            label="Pregunta enviada al cliente"
          ...
          <div>
            <label className="mb-1 block text-xs text-muted-foreground">
              Clave de variable (guardada en flow_runs.vars; alfanumérico + guion bajo)
            </label>
            <Input
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Insértala en preguntas posteriores y notas de transferencia con{" "}
          ...
          <NextNodeRow
            ...
            currentKey={node.node_key}
            onChange={(v) => onUpdateConfig({ next_node_key: v })}
            label="Después de capturar, avanza a"
          />
        </>
      );
    ...
    case "handoff":
      return (
        <TextRow
          label="Nota interna (para el agente que la recibe)"
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          ...
          marca como completa. No requiere configuración.
        </p>
      );
  }
}
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          <label className="text-xs text-muted-foreground">
            Botones (1–3) — cada uno dirige a un nodo diferente
          </label>
        </div>
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label="Etiqueta del botón desplegable (≤20 caracteres)"
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="absent">no está presente</SelectItem>
...
function SendMediaForm({
  ...
  return (
    <>
      <div>
        <label className="mb-1 block text-xs text-muted-foreground">Tipo de multimedia</label>
        <Select
          value={mediaType}
          onValueChange={(v) => {
        ...
        >
          ...
          <SelectContent>
            <SelectItem value="image">Imagen (PNG, JPEG, WebP)</SelectItem>
      ...
      <TextRow
        label="Descripción (opcional, se muestra debajo del contenido multimedia)"
        value={cfg.caption ?? ""}
      ...
      {isDocument && (
        <div>
          <label className="mb-1 block text-xs text-muted-foreground">
            Nombre de archivo mostrado al cliente (solo documentos)
          </label>
          <Input
            value={cfg.filename ?? ""}
      ...
      <NextNodeRow
        ...
        currentKey={currentKey}
        onChange={(v) => onUpdateConfig({ next_node_key: v })}
        label="Después de enviar, avanza a"
      />
    </>
  );
}
