  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Vuelve a ingresar el Access Token para guardar los cambios');
        setSaving(false);
        return;
      }
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciales guardadas y verificadas. Se omitió el registro entrante (sin PIN) — ver el estado de registro más abajo.',
          { duration: 10000 },
        );
        setPin('');
      } else {
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        ...
        toast.error(
          'El número no está completamente registrado. Revisa las verificaciones abajo para ver qué paso falló.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
    ...
    return (
      <section className="animate-in fade-in-50 duration-200">
        <SettingsPanelHead
          ...
          description="Conecta tu Meta WhatsApp Business API. Las credenciales, el webhook y los pasos de configuración están todos aquí."
        />
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Tu access token se autentica con Meta. Revisa el estado de registro más abajo para saber si los webhooks realmente están conectados.'
              : statusMessage ||
              ...
              {isRegistered ? (
                <>
                  ...
                  {config.registered_at
                    ...
                    : 'desconocido'}
                  . Haz clic en <strong>Verificar con Meta</strong> si dejan
                  de llegar eventos.
                </>
                ...
                <>
                  ...
                  . Ingresa (o corrige) el PIN de verificación en dos pasos
                  abajo y haz clic en Guardar configuración para reintentar.
                </>
              ) : (
                <>
                  Este número se guardó antes de que existiera el
                  seguimiento de registro, o el registro se omitió. Ingresa
                  el PIN de verificación en dos pasos abajo y haz clic en
                  Guardar configuración para suscribirlo.
                </>
              )}
            </AlertDescription>
            ...
            {registrationProbe && (
              <div className="mt-3 rounded border border-border bg-card/60 px-3 py-2 space-y-1.5 text-[11px]">
                <p className="font-medium text-foreground">
                  Diagnóstico — última ejecución: {' '}
                  <span className={registrationProbe.live ? 'text-emerald-400' : 'text-amber-400'}>
                    {registrationProbe.live ? 'activo' : 'inactivo'}
                  </span>
                </p>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Ingresa tus credenciales de la Meta WhatsApp Business API.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Solo es necesario para conectar mensajes <strong className="text-muted-foreground">entrantes</strong> en
                un número de <strong className="text-muted-foreground">producción</strong>. Configúralo en{' '}
                ...
                <strong className="text-muted-foreground">Los números de prueba de Meta</strong> no
                tienen PIN y ya están registrados — déjalo en blanco para
                ellos. Dejarlo en blanco también mantiene intacto un
                registro existente.
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Usa esta URL como tu callback de webhook en el Meta App Dashboard.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
      ...
      <div>
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Sigue estos pasos para conectar tu WhatsApp Business API.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Accordion>
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Completa los datos de la app y créala</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Sigue el asistente de configuración para vincular tu negocio</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Copia tu <strong className="text-foreground">Phone Number ID</strong></li>
                    <li>Copia tu <strong className="text-foreground">WhatsApp Business Account ID</strong></li>
                    <li>Genera un <strong className="text-foreground">token de acceso permanente</strong> desde Business Settings &gt; System Users</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Haz clic en &quot;Edit&quot; en la sección de Webhook</li>
