    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-muted-foreground">
          Campos adicionales de contacto (ej. código postal, origen del lead). Aparecen en
          cada contacto y en la acción de automatización “Actualizar campo de contacto”.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <CustomFieldsPanel />
