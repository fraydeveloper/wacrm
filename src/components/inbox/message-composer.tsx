          ...
          kind === "image"
            ...
            : kind === "video"
              ...
              : kind === "document"
                ...
                : "audio";
        toast.error(
          `El archivo pesa ${(file.size / 1024 / 1024).toFixed(1)} MB — el límite para ${kindLabel} es ${Math.round(
            max / 1024 / 1024,
          )} MB.`,
        );
        return;
    ...
    <div className="border-t border-border bg-card p-3">
      ...
      {draft ? (
        ...
        <div className="flex items-end gap-2">
          ...
          <textarea
            ...
            placeholder={
              readOnly
                ? "Solo lectura — los observadores pueden ver pero no responder"
                : sessionExpired
            ...
            title={readOnly ? "Solo lectura — tu rol no permite enviar mensajes" : undefined}
            className={cn(
      ...
      {!draft && !recording && (
        <p className="mt-1 pl-[5.5rem] text-[10px] text-muted-foreground">
          Toca el ✨ para generar una respuesta con IA — puedes editarla antes de enviar
        </p>
      )}
    </div>
  );
