...
const FAIL_COPY: Record<PeekFail['reason'], { title: string; body: string }> = {
  not_found: {
    ...
    body: 'Este enlace no corresponde a una invitación válida. Verifica la URL o pide a la persona que te invitó que te envíe una nueva.',
  },
  used: {
    title: 'Invitación ya utilizada',
    body: 'Esta invitación ya ha sido aceptada. Si no fuiste tú, pide al administrador de la cuenta que envíe un nuevo enlace.',
  },
  expired: {
    title: 'Invitación expirada',
    body: 'Esta invitación ha expirado. Pide al administrador de la cuenta que envíe una nueva — solo toma unos segundos generarla.',
  },
  server_error: {
        ...
        <Card className="w-full max-w-md border-border bg-card">
          ...
          <CardContent className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-muted-foreground">
              Al aceptar, tu cuenta se moverá a{' '}
          ...
          <DialogContent className="bg-popover border-border sm:max-w-md">
            ...
            <div className="space-y-2 py-2 text-xs text-muted-foreground">
              <p>
                ...
                cierra sesión y regístrate de nuevo con una dirección de
                correo diferente. El enlace de invitación seguirá siendo
                válido mientras no haya expirado.
              </p>
            </div>
