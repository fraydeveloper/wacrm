...
export default function AutomationsPage() {
  ...
  async function load() {
    try {
      ...
      setError(err instanceof Error ? err.message : "Error al cargar las automatizaciones")
    }
  }
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-foreground">{pendingDelete?.name}</span> y su historial
              de ejecución. Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
        ...
        >
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
            ...
            <span className="tabular-nums">
              {automation.execution_count} {automation.execution_count === 1 ? "ejecución" : "ejecuciones"}
            </span>
